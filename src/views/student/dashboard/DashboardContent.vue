<template>
  <div class="flex flex-col gap-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
      ...
      <div
        class="lg:col-span-4 bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden"
        v-motion="{
      ...
      >
        <div class="p-6" :style="{
          ...
          <div class="text-center mt-4 text-white">
            <h2 class="font-bold text-xl">{{ user?.name || 'Student Name' }}</h2>
            <p class="text-blue-100 text-sm">{{ user?.username || '00' }}</p>
          </div>
        </div>
        ...
        <div class="p-6">
          ...
          <div class="space-y-4">
            <div class="flex items-center gap-3">
              <div class="p-2 rounded-lg" :style="{ backgroundColor: 'rgba(var(--primary-color-rgb), 0.1)' }">
          ...
          <div class="mt-6">
            <But-ton label="View Full Profile" icon="pi pi-user" outlined class="w-full" />
          </div>
        </div>
      </div>
