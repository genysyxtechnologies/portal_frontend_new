  ...
  <div class="flex flex-col gap-6">
    ...
    <div class="grid grid-cols-12 h-[calc(100vh-180px)] gap-4">
      ...
      <div class="col-span-5 bg-[#fff] rounded-xl flex justify-center">
        <UserInformation
          :first-label="'Name'"
          :second-label="'Matric No'"
          :third-label="'Level'"
          :first-input="user?.name"
          :second-input="user?.username"
          :third-input="user?.level.title"
        />
      </div>
      <!-- Bio Data -->
      ...
      <div class="col-span-7 w-full rounded-xl flex justify-center">
        <StudentInformation
          :state="user?.information.state.name"
          :local-government="user?.information.lga.name"
          :email="user?.email"
          :phone="user?.phone"
          :level="user?.level.title"
          :year-of-admission="user?.yearOfAdmission.name"
          :programme-type="user?.programme.programmeType.name"
          :faculty="user?.programme.department.faculty.name"
          :department="user?.programme.department.name"
