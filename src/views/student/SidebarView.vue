          ...
          <span @click="item.hasChildren ? toggleDropdown(index) : handleRoute(item.path)">
            ...
            >
              ...
              <div
                ...
                class="dropdown-icon"
                :class="{ 'dropdown-open': openDropdowns[index] }"
              >
                <i
                  :class="['pi', openDropdowns[index] ? 'pi-chevron-down' : 'pi-chevron-right']"
                ></i>
              </div>
...
.menu-item.active {
  ...
  background: linear-gradient(90deg, rgba(13, 71, 161, 0.1) 0%, rgba(13, 71, 161, 0.04) 100%);
  color: #0d47a1;
