      ...
      <div class="w-full lg:w-1/2 transition-all duration-300">
        ...
        <div
            ...
            <transition-group name="list" tag="div">
              <div v-for="course in registeredCourses" :key="`registered-${course.id}`"
                ...
                <div class="flex items-center p-4 gap-3">
                  <Check-box v-model="course.selected" :binary="true" @change="handleCourseRemovalCheckBox(course)"
                    class="custom-checkbox" />
                  <div class="flex-1 min-w-0 ml-4">
                    <div class="flex justify-between items-baseline">
                      <div>
          ...
          <div v-if="selectedCount > 0"
            ...
            <div class="text-sm text-gray-500">
              <span class="font-medium">{{ selectedCount }}</span> of {{ registeredCourses.length }} selected
            </div>
