    ...
    <transition name="fade">
      <div v-if="!loading" class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <div class="relative">
            <Sel-ect :size="'large'" v-model="selectedCountry" :options="[user?.information.country]" optionLabel="name"
              placeholder="Select Session" class="card w-full" :disabled="!editableFields.country" />
            <EditToggle :is-editing="editableFields.country" @click="toggleEdit('country')"
        ...
        <div>
          ...
          <div class="relative">
            <Sel-ect :size="'large'" v-model="selectedState" :options="[user?.information.state]" optionLabel="name"
              placeholder="Select Session" class="card w-full" :disabled="!editableFields.state" />
            <EditToggle :is-editing="editableFields.state" @click="toggleEdit('state')"
              class="absolute right-3 top-3" />
          </div>
        </div>
        ...
        <div>
          ...
          <div class="relative">
            <InputText id="lgaCity" v-model="formData.lgaCity" type="text" class="w-full pr-10"
              :placeholder="user?.information.lga?.name || 'Enter LGA/City'" :readonly="!editableFields.lgaCity"
              :class="{ 'bg-gray-50': !editableFields.lgaCity }" />
            <EditToggle :is-editing="editableFields.lgaCity" @click="toggleEdit('lgaCity')"
              class="absolute right-3 top-3" />
          </div>
        </div>
        ...
        <div>
          <label for="contactAddress" class="block text-sm font-medium text-gray-700 mb-1 labels">Contact
            Address</label>
          <div class="relative">
            <InputText id="contactAddress" v-model="formData.contactAddress" type="text" class="w-full pr-10"
              :placeholder="user?.information.contactAddress || 'Enter Contact Address'"
              :readonly="!editableFields.contactAddress" :class="{ 'bg-gray-50': !editableFields.contactAddress }" />
            <EditToggle :is-editing="editableFields.contactAddress" @click="toggleEdit('contactAddress')"
              class="absolute right-3 top-3" />
          </div>
        </div>
        ...
        <div>
          ...
          <div class="relative">
            <InputText id="hometown" v-model="formData.hometown" type="text" class="w-full pr-10"
              :placeholder="user?.information.homeTown || 'Enter Hometown'" :readonly="!editableFields.hometown"
              :class="{ 'bg-gray-50': !editableFields.hometown }" />
            <EditToggle :is-editing="editableFields.hometown" @click="toggleEdit('hometown')"
              class="absolute right-3 top-3" />
          </div>
        </div>
        ...
        <div>
          ...
          <div class="relative">
            <InputText id="homeAddress" v-model="formData.homeAddress" type="text" class="w-full pr-10"
              :placeholder="user?.information.homeAddress || 'Enter Home Address'"
              :readonly="!editableFields.homeAddress" :class="{ 'bg-gray-50': !editableFields.homeAddress }" />
            <EditToggle :is-editing="editableFields.homeAddress" @click="toggleEdit('homeAddress')"
              class="absolute right-3 top-3" />
          </div>
        </div>
        ...
        <div>
          ...
          <div class="relative">
            <InputText id="placeOfBirth" v-model="formData.placeOfBirth" type="text" class="w-full pr-10"
              :placeholder="user?.information.placeOfBirth || 'Enter Place of Birth'"
              :readonly="!editableFields.placeOfBirth" :class="{ 'bg-gray-50': !editableFields.placeOfBirth }" />
            <EditToggle :is-editing="editableFields.placeOfBirth" @click="toggleEdit('placeOfBirth')"
              class="absolute right-3 top-3" />
          </div>
        </div>
        ...
        <div>
          ...
          <div class="relative">
            <InputText id="dateOfBirth" class="w-full pr-10"
              :value="formData.dateOfBirth || formatDateOfBirth(user?.information?.dob)" readonly
        ...
        <!-- Gender -->
        <div>
          <label for="gender" class="block text-sm font-medium text-gray-700 mb-1 labels">Gender</label>
          <div class="relative">
            <InputText id="gender" class="w-full pr-10" :value="formData.gender || 'Not Specified'" readonly
              :class="{ 'bg-gray-50': true }" />
            <LockIndicator class="absolute right-3 top-3" />
          </div>
        </div>
        ...
        <!-- Religion -->
        <div>
          <label for="religion" class="block text-sm font-medium text-gray-700 mb-1 labels">Religion</label>
          <div class="relative">
            <Sel-ect :size="'large'" v-model="selectedReligion" :options="[user?.information.religion]"
              optionLabel="title" placeholder="Select Religion" class="card w-full"
              :disabled="!editableFields.religion" />
            <EditToggle :is-editing="editableFields.religion" @click="toggleEdit('religion')"
              class="absolute right-3 top-3" />
          </div>
        </div>
        ...
        <div>
          <label for="maritalStatus" class="block text-sm font-medium text-gray-700 mb-1 labels">Marital Status</label>
          <div class="relative">
            <Sel-ect :size="'large'" v-model="selectedMaritalStatus" :options="[user?.information.maritalStatus]"
              optionLabel="title" placeholder="Select Marital Status" class="card w-full"
              :disabled="!editableFields.maritalStatus" />
            <EditToggle :is-editing="editableFields.maritalStatus" @click="toggleEdit('maritalStatus')"
              class="absolute right-3 top-3" />
          </div>
        </div>
        ...
        <div class="flex justify-end mt-8">
          <Button label="Save Changes" @click="handleSave" class="p-button-primary" :disabled="!hasChanges || loading"
            v-if="isEditingAnyField" />
          <Button label="Next" @click="handleNext" class="p-button-primary" :disabled="loading" v-else />
        </div>
      </div>
    </transition>
...
const isEditingAnyField = computed(() => {
  sessionStorage.setItem('isEditingBiodataAnyField', JSON.stringify(Object.values(editableFields.value).some(val => val)));
