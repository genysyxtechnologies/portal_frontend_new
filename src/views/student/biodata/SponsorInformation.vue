  ...
  <div class="container mx-auto p-8 bg-white rounded-lg shadow-md relative min-h-[500px]">
    ...
    <transition name="fade">
      <div v-if="!loading" class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <!-- Next of KIN name -->
        <div>
          <label for="nextOfKinName" class="block text-sm font-medium text-gray-700 mb-1 labels">Next of KIN
            Name</label>
          <div class="relative">
            <InputText id="nextOfKinName" v-model="formData.nextOfKinName" type="text" class="w-full pr-10"
              :readonly="!editableFields.nextOfKinName" :class="{ 'bg-gray-50': !editableFields.nextOfKinName }" />
            <EditToggle :is-editing="editableFields.nextOfKinName" @click="toggleEdit('nextOfKinName')"
        ...
        <div>
          <label for="nextOfKinPhone" class="block text-sm font-medium text-gray-700 mb-1 labels">Next of KIN
            Phone</label>
          <div class="relative">
            <InputText id="nextOfKinPhone" v-model="formData.nextOfKinPhone" type="text" class="w-full pr-10"
              :placeholder="user?.information.nextOfKinPhone || 'Enter Next of KIN Phone'"
              :readonly="!editableFields.nextOfKinPhone" :class="{ 'bg-gray-50': !editableFields.nextOfKinPhone }" />
            <EditToggle :is-editing="editableFields.nextOfKinPhone" @click="toggleEdit('nextOfKinPhone')"
              class="absolute right-3 top-3" />
          </div>
        </div>
        ...
        <div>
          <label for="nextOfKinAddress" class="block text-sm font-medium text-gray-700 mb-1 labels">Next of KIN
            Address</label>
          <div class="relative">
            <InputText id="nextOfKinAddress" v-model="formData.nextOfKinAddress" type="text" class="w-full pr-10"
            ...
            <EditToggle :is-editing="editableFields.nextOfKinAddress" @click="toggleEdit('nextOfKinAddress')"
              class="absolute right-3 top-3" />
          </div>
        </div>
        ...
        <div>
          <label for="nextOfKinRelationship" class="block text-sm font-medium text-gray-700 mb-1 labels">Relationship
            with Next of KIN</label>
          <div class="relative">
            <Sel-ect :size="'large'" v-model="selectedNextOfKinRelationship"
              :options="[user?.information.nextOfKinRelationship]" optionLabel="title"
              placeholder="Select Relationship with Next of KIN" class="card w-full"
              :disabled="!editableFields.nextOfKinRelationship" />
            <EditToggle :is-editing="editableFields.nextOfKinRelationship" @click="toggleEdit('nextOfKinRelationship')"
              class="absolute right-3 top-3" />
          </div>
        </div>
